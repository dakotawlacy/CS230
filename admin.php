        ...
        <div class="my-auto">
            ...
            <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="images/default.jpeg" alt="profile pic" onclick="triggered();" id="gallery-display">
                ...
                <div class="form-group">
                <button class="btn btn-lg btn-outline-success btn-block" name="gallery-submit" type="submit">upload</button>
